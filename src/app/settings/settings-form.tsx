...
import { Loader2, Save, Clock, QrCode, Building2 } from 'lucide-react'
        ...
        <CardContent className="space-y-4">
          <div className="grid grid-cols-2 gap-4">
            <Input
              ...
              onChange={(e) => setSettings({ ...settings, cutoff_hour: parseInt(e.target.value) || 7 })}
            />
            <Input
              id="cutoff-minute"
              ...
              onChange={(e) => setSettings({ ...settings, cutoff_minute: parseInt(e.target.value) || 30 })}
            />
          </div>
